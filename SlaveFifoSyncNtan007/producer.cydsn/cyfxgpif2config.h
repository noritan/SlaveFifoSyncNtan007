/*
 * Project Name: producer.cyfx
 * Time : 11/20/2012 13:23:22
 * Device Type: FX3
 * Project Type: GPIF2
 *
 *
...
CyU3PGpifWaveData CyFxGpifWavedata[]  = {
    {{0x1E739A01,0x00000100,0x80C00008},{0x00000000,0x00000000,0x00000000}},
    {{0x1E739202,0x20400000,0x80000004},{0x00000000,0x00000000,0x00000000}},
    {{0x1E739A03,0x04000100,0x80C00008},{0x00000000,0x00000000,0x00000000}},
    {{0x1E739204,0x24800000,0x80000004},{0x00000000,0x00000000,0x00000000}}
};
...
uint32_t CyFxGpifRegValue[]  = {
    ...
    0x55400400,  /*  CY_U3P_PIB_GPIF_CTRL_BUS_DIRECTION */
    ...
    0x00001FFF,  /*  CY_U3P_PIB_GPIF_CTRL_COUNT_LIMIT */
