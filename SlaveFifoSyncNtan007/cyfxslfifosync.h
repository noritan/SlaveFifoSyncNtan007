...
#define CY_FX_PRODUCER_PPORT_SOCKET0    CY_U3P_PIB_SOCKET_0    /* P-port Socket 0 is producer */
#define CY_FX_PRODUCER_PPORT_SOCKET1    CY_U3P_PIB_SOCKET_1    /* P-port Socket 1 is producer */
